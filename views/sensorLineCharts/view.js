...
request.open("GET", "../../data/BuildingProxSensorData/json/f1z8a-MC2.json", false);
request.send(null);
var f1z8a = JSON.parse(request.responseText);
request.open("GET", "../../data/BuildingProxSensorData/json/f2z2-MC2.json", false);
request.send(null);
var f2z2 = JSON.parse(request.responseText);
request.open("GET", "../../data/BuildingProxSensorData/json/f2z4-MC2.json", false);
request.send(null);
var f2z4 = JSON.parse(request.responseText);
request.open("GET", "../../data/BuildingProxSensorData/json/f3z1-MC2.json", false);
request.send(null);
